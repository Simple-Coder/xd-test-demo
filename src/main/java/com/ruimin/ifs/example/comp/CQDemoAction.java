...
public class CQDemoAction extends SnowAction {
	...
	@Action
	@SnowDoc(desc = "search")
	public PageQueryResult listAll(QueryParamBean queryBean)throws SnowException {
		
		System.out.println(queryBean.getParameter("t")+"============");
		...
		for (int i = start; i < start + 10; i++) {
			...
			bean.setF2("你好 world你好你好你好你好你好你好你好"+i);
			list.add(bean);
		}
		if(!StringUtils.isEmpty(queryBean.getParameter("brcode"))){
			SnowExceptionUtil.throwErrorException("111111");
		}
