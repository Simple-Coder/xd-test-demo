...
public class BiNationregionEntryAction extends SnowAction {
	...
	public PageResult queryAll(QueryParamBean queryBean) throws SnowException{
		...
		return BiNationregionEntryService.getInstance().queryList(qid, qnationregionNumber, cnEnFullName, cnEnShortName, queryBean.getPage());
	}
	...
	public void saveOrUpdate(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"国家/代码修改:id="+biNationregionEntryVO.getNationregionCode() });
	}
	...
	public void saveOrUpdate1(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		SessionUserInfo sessionUserInfo = SessionUserInfo.getSessionUserInfo();
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"国家/代码新增:id="+biNationregionEntryVO.getNationregionCode()});
	}
	...
	public void delete(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		SessionUserInfo sessionUserInfo = SessionUserInfo.getSessionUserInfo();
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"国家/代码删除:id="+biNationregionEntryVO.getNationregionCode()});
	}
