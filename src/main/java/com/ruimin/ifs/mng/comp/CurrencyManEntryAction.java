...
public class CurrencyManEntryAction extends SnowAction {
	...
	public void saveOrUpdate(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"币种信息修改:id="+tblCurInf.getCurcd()});
	}
	...
	public void saveOrUpdate1(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		SessionUserInfo sessionUserInfo = SessionUserInfo.getSessionUserInfo();
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"币种信息新增:id="+tblCurInf.getCurcd()});
	}
	...
	public void delete(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		SessionUserInfo sessionUserInfo = SessionUserInfo.getSessionUserInfo();
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"币种信息删除:id="+tblCurInf.getCurcd()});
	}
