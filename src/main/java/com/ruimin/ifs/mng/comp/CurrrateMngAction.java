...
public class CurrrateMngAction extends SnowAction {
	...
	public void saveOrUpdate(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),msg+tblCurRate.getId()});
	}
	...
	public void delete(Map<String, UpdateRequestBean> updateMap) throws SnowException{
		...
		SessionUserInfo sessionUserInfo = SessionUserInfo.getSessionUserInfo();
		sessionUserInfo.addBizLog("update.log",new String[]{sessionUserInfo.getTlrno(),sessionUserInfo.getBrCode(),"汇率信息删除:id="+id});
	}
