...
<snow:page title="Demo" appendCss="/pages/example/css/demo.css,/public/lib/fontawesome4/css/font-awesome.css">
		...
		<snow:Layoutleft id="left" collapsed="false" width="205" title="菜单">
			<snow:accordion id="menus">
				...
				<snow:accordionitem id="m2" title="表格(Grid)">
					...
					<snow:button desc="表格-可编辑" id="editablegrid"></snow:button>
					<snow:button desc="表格-树" id="treegrid"></snow:button>
...
<%-- 					<snow:button desc="带复选框的树" id="treewithcheckbox" /> --%>
				...
				<snow:accordionitem id="m7" title="范例">
					...
					<snow:button desc="文件上传" id="demo2" />
					<snow:button desc="富文本编辑" id="demo3" />
...
// 			sortgrid : '/pages/example/code/tab.jsp?jsp=datagrid_sort&dataset=GridFields',
 			...
 			editablegrid : '/pages/example/code/tab.jsp?jsp=datagrid_editable&dataset=GridFields',
 			treegrid : '/pages/example/code/tab.jsp?jsp=datagrid_tree&dataset=GridFields',
			...
			demo : '/pages/example/code/tab.jsp?jsp=demo',	
 			demo2 : '/pages/example/jsp/fileUpload.jsp',	
 			demo3 : '/pages/example/code/tab.jsp?jsp=kind_demo&dataset=KindBean'	
		}
