...
<snow:page title="demo_field_1">
	...
	<snow:form label="前台验证" dataset="GroupValidateFields" fieldstr="requireField,mail,number,maxNumber,url,chinese,password,numOrWord,multiValidate,currency,textarea,c1" id=""></snow:form>
