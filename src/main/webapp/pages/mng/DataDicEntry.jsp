...
<snow:page title="数据字典配置">
	...
	<snow:query label="请输入查询条件" id="queryId" dataset="DataDicEntry" fieldstr="qDataTypeNo,qDataTypeName,qDataNo,qDataName"></snow:query>
	<snow:grid dataset="DataDicEntry" sortable="true" remotesort="true" id="gridId" fieldstr="dataTypeNo,dataTypeName,dataNo,dataName,opr[160]" paginationbar="btnAdd"></snow:grid>
	<!-- 可使用一个窗体 -->
	...
	<snow:window id="windowAddId" title="数据字典 --> 新增" modal="true" closable="true" buttons="btnSave1">
