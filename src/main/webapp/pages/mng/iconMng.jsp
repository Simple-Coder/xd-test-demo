...
<snow:page title="图标管理">
	<snow:dataset id="icon" path="com.ruimin.ifs.mng.dataset.Icon" init="true" parameters="cache=false;iconCssFile=/public/lib/fontawesome4/css/font-awesome.css"></snow:dataset>
